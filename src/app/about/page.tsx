    ...
    >
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <blockquote className="text-custom-base-regular italic text-center">
          &quot;Mình đã từng nghĩ không khí là miễn phí cho đến khi mua gói bim
          bim&quot;
        </blockquote>
      </div>
      <Separator />
      ...
      >
        ...
        Developer và xa hơn là Cloud. <br />
        Mình thích mày mò những thứ về giao diện (dù mình không phải designer
        hehe!). Đó có thể là những animation, visualizer, UI library,... vì mình
        phải chiều người dùng nhất có thể mà. Mình còn có ý định tìm hiểu sâu
        hơn về hệ thống nữa vì mình thích logic. <br />
        Sở thích của mình không nhiều. Mình thích chơi game vì nó cho mình cảm
        nhận được sự hồi hộp, gay cấn và đòi hỏi cả những sự tính toán. Mình còn
        ham tập tạ vì cơ thể khỏe mạnh mà không vận động thì phí lắm á. Mình
        thích những ngày mưa se lạnh, bật list nhạc yêu thích rồi làm một việc
        nào đó, thích cực! (nóng thì thôi, xin được bật điều hòa 🙃)
      </motion.p>
      <motion.p
